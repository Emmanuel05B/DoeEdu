...
// Get tutor ID
$stmt = $connect->prepare("SELECT u.Id FROM users u JOIN tutors t ON u.Id = t.TutorId WHERE u.Email = ?");
...
$uploadedResources = [];
$stmt = $connect->prepare("
  SELECT r.Id, r.Title, r.ResourceType, s.SubjectName, c.Grade
  FROM resources r
