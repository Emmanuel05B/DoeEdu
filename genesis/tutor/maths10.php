          ...
          <div class="box box-primary">
            ...
            <div class="box-body pad table-responsive">
              ...
              <table class="table table-bordered text-center">
                ...
                <tr>
                  <td>
                    <a href="recmodal.php?gra=10&sub=5&cha=Exponents" class="btn btn-block btn-info btn-lg">Exponents</a>
                  </td>
                  <td>
                    <a href="recmodal.php?gra=10&sub=5&cha=Functions" class="btn btn-block btn-warning btn-lg">Functions</a>
                  </td>
                  <td>
                    <a href="recmodal.php?gra=10&sub=5&cha=Statistics" class="btn btn-block btn-success btn-lg">Statistics</a>
                  </td>
                  <td>
                    <a href="recmodal.php?gra=10&sub=5&cha=Probability" class="btn btn-block btn-primary btn-lg">Probability</a>
                  </td>
                </tr>
                <tr>
                  <td>
