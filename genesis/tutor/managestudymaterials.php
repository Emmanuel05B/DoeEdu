        ...
        <div class="box-body" style="background-color:#eaf4e4;">
          <form action="upload_resource.php" method="POST" enctype="multipart/form-data">
            <div class="row">
              ...
              $stmt = $connect->prepare("SELECT DISTINCT SubjectId FROM tutorsubject WHERE TutorId = ?");
              ...
              <div class="col-md-4 form-group">
                ...
                <select name="subject_grade" class="form-control" required>
                  ...
                  <?php foreach ($subjectGradePairs as $pair): 
                    $value = $pair['subjectId'];
                    $label = $pair['subjectName'] . " - Grade " . $pair['grade'];
                  ?>
