          ...
          <form action="save_profile.php" method="POST" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-md-4 text-center">
                <img src="<?php echo $tutor['ProfilePicture'] ?? 'profile_pics/default_avatar.png'; ?>" alt="Profile Picture" class="img-thumbnail" style="width:150px; height:150px;">
                <br><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="bio" name="bio" rows="2" placeholder="Short bio about yourself"><?php echo htmlspecialchars($tutor['Bio']); ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="qualifications" name="qualifications" rows="2" placeholder="Your qualifications"><?php echo htmlspecialchars($tutor['Qualifications']); ?></textarea>
                    </div>
                  </div>
