    ...
    <section class="ftco-section ftco-cart">
            <div class="centr">
                ...
                <tr>
                  ...
                  <td><p><a class="button" href="addparent.php?id=<?php echo $final['LearnerId'] ?>" >Add Parent </a></p></td>
                  <td><p><a class="button" href="updateparent.php?id=<?php echo $final['LearnerId'] ?>" >Update Parent Details</a></p></td>
