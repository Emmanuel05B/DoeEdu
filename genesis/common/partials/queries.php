...
<!-- jQuery UI 1.11.4 -->
<script src="../../common/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<script src="../../common/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="../../common/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="../../common/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="../../common/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="../../common/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
