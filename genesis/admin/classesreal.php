        ...
        <div class="col-md-3">
          <div class="box box-primary">
            <div class="box-header with-border text-center" style="background-color:#a3bffa;">
              ...
              <p><i class="fa fa-book"></i> <?php echo $subjectName; ?><?php echo ' '; ?><i class="fa fa-book"></i><?php echo 'Group xx'; ?></p>
              <p><i class="fa fa-users"></i> <strong><?php echo $learnerCount; ?> learner<?php echo $learnerCount != 1 ? 's' : ''; ?></strong></p> 
            </div>
            <div class="box-body text-center">
              <a href="chapters.php?subject=<?php echo $subjectId ?>&grade=<?php echo $grade ?>" class="btn btn-info btn-sm" style="width: 100px;">Record Marks</a>
              <a href="actychapters.php?subject=<?php echo $subjectId ?>&grade=<?php echo $grade ?>" class="btn btn-info btn-sm" style="width: 100px;">Create Quiz</a>
              <a href="managestudymaterials.php?subject=<?php echo $subjectId ?>&grade=<?php echo $grade ?>" class="btn btn-info btn-sm" style="width: 100px;">Resources</a>
              <a href="alllearner.php?subject=<?php echo $subjectId ?>&grade=<?php echo $grade ?>" class="btn btn-info btn-sm" style="width: 100px;">Open Class</a>
            </div>  
          </div>
        </div>
      <?php } ?>
