...
// Invite requests
$inviteQuery = $connect->query("
    SELECT COUNT(*) as count
    FROM inviterequests ir
    LEFT JOIN users u ON ir.email = u.Email
    WHERE u.Id IS NULL
");
...
// Number of Tutor Applications
$tutorAppsQuery = $connect->query("SELECT COUNT(*) AS count FROM tutorapplications");
$tutorApplicationsCount = $tutorAppsQuery ? $tutorAppsQuery->fetch_assoc()['count'] : 0;

// Number of Marketer Applications

$marketerAppsQuery = $connect->query("SELECT COUNT(*) AS count FROM marketerapplications");
$marketerApplicationsCount = $marketerAppsQuery ? $marketerAppsQuery->fetch_assoc()['count'] : 0; 
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="small-box" style="background-color: #b2ebf2;">
              ...
              <a href="tutorapplications.php" class="small-box-footer">open <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="small-box" style="background-color: #dd90d3ff;">
              <div class="inner">
                <h3><?= $marketerApplicationsCount ?></h3>
                <p>Marketer Applications</p>
              </div>
              <a href="marketerapplications.php">
                <div class="icon" style="font-size: 50px; top: 10px;">
                  <i class="fa fa-user-plus"></i>
                </div>
              </a>
              <a href="marketerapplications.php" class="small-box-footer">
