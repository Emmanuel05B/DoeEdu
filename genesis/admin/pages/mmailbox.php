...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Mailbox
        <small><?php echo $messagesrow['count'];?> new messages</small>
      </h1>
      <ol class="breadcrumb">
              ...
              <div class="table-responsive mailbox-messages"><br>
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td><p><a class="btn btn-default btn-sm" href="trashhandler.php?id=<?php echo $final['No'] ?>"> <i class="fa fa-trash-o"></i></a></p></td>
