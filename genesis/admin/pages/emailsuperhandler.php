...
function initMailer() {
    ...
    $mail->isSMTP();
    $mail->Host       = $_ENV['EMAIL_HOST'];   ///could be smtp.hostinger.com or smtp.gmail.com..      
    $mail->SMTPAuth   = true;
...
try {
    ...
    switch($action) {
        ...
        // 9 but 6 in tutors. Feedback emails to parents for offline (class-based) non-submissions or absences.
