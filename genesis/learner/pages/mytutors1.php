          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              $stmt3 = $connect->prepare("
                SELECT ts.SessionId, ts.SlotDateTime, ts.Subject, ts.Status, ts.MeetingLink, 
                      u.Name, u.Surname 
              ...
              ?>
                <tr>
                  ...
                  <?php if ($status === 'Confirmed' && !empty($booking['MeetingLink'])): ?>
                      <a href="<?= htmlspecialchars($booking['MeetingLink']) ?>" target="_blank" class="btn btn-xs btn-success">
