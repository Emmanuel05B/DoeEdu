        ...
        <div class="box-body" style="background-color:#ffffff;">
          <div class="table-responsive">
            <table class="table table-bordered table-hover" id="resourceTable">
              ...
              <tbody>
                <?php
                // Fetch slide resources assigned to this class
                $sql = "
                ...
                if ($result && $result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                      ...
                      <td><?= $description ?></td>
                      <td>
                        <a href="<?= $fileUrl ?>" target="_blank" class="btn btn-xs btn-primary" title="View">
                  ...
                  echo '<tr><td colspan="4" class="text-muted">No slides assigned to this class.</td></tr>';
                }
                $stmt->close();
                ?>
              </tbody>
