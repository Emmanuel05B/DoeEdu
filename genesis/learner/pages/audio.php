...
include(__DIR__ . "/../../common/partials/queries.php"); // contains $connect
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <?php
                // Fetch only audio resources assigned to this class
                $sql = "
                ...
                <?php
                  ...
                  echo '<p class="text-muted">No audio lessons assigned to this class.</p>';
                }
                $stmt->close();
                ?>
